...
const tracks: Track[] = [
  {
    id: 1,
    title: 'Scott Street',
    description: 'In every universe, I’d choose you 💞',
  ...
  },
  {
    id: 2,
    title: 'Dress',
    description: "Same show, same feeling - you next to me 🤍",
  ...
  },
  {
    ...
    description: 'A TSITP memory - the kind that stays 💞',
  ...
  },
  {
    id: 4,
    title: 'Cruel Summer',
    description: 'The nights we hit play and disappeared 🤍',
  ...
  },
  {
    id: 5,
    title: 'Deja Vu',
    description: 'Where the world got quiet and you felt close 💞',
  ...
  },
  {
    id: 6,
    title: 'False God',
    description: 'Just us, the screen, and that feeling 🤍',
  ...
  },
  {
    id: 8,
    title: 'Daylight',
    description: 'Summer on the screen, you in my heart 🤍',
